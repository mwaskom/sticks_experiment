...
def behavioral_exit(log):
    ...
    print("\nPerformance:")
    print("\nAccuracy:")
    print(df.pivot_table("correct", "context", "context_strength"))
    print("\nRT:")
    print(df.pivot_table("rt", "context", "context_strength"))
    print("\nBias:")
    print(df.pivot_table("response", "context", "context_strength"))
    print("\nDropped frames:")
...
def scan_exit(log):
    ...
    print("\nBias:")
    print(df.pivot_table("response", "context", "context_diff"))
    print("\nMissed responses:")
